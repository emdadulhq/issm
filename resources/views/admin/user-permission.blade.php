...
<!-- Mirrored from 3i Scholling.themetrades.com/demo/admin/teacher-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 13:11:35 GMT -->
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="3i Scholling : Education HTML Template" />

	<!-- OG -->
	<meta property="og:title" content="3i Scholling : Education HTML Template" />
	<meta property="og:description" content="3i Scholling : Education HTML Template" />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>3i Scholling : Education HTML Template </title>
	...
	<div class="ttr-sidebar">
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<div class="ttr-sidebar-logo">
				<a href="{{ route('home') }}"><img alt="" src="{{URL::to('assets/images/logo.png')}}" width="122" height="27"></a>
		...
		<div class="ttr-sidebar-wrapper content-scroll">
			<!-- side menu logo start -->
			<div class="ttr-sidebar-logo">
				<a href="{{ route('home') }}"><img alt="" src="{{URL::to('assets/images/logo.png')}}" width="82" height="27"></a>
				<!-- <div class="ttr-sidebar-pin-button" title="Pin/Unpin Menu">
					<i class="material-icons ttr-fixed-icon">gps_fixed</i>
					<i class="material-icons ttr-not-fixed-icon">gps_not_fixed</i>
				</div> -->
	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title">User Permission</h4>
						...
						<div class="">
								...
								<div class="">
									...
									<table class="table table-striped">
										...
										<tr>
											...
											<td>{{$user-> phone}}</td>
											<td>Male</td>
											<td class="badge badge-success">Quiz, Mail, Course</td>
								...
								<div class="modal-dialog modal-dialog-centered">
									<div class="modal-content">
										<div class="modal-header">
											<h2 style="text-align: center;"> User Permission of Md. Imdadul Haque
											</h2><button class="close"
										...
										<div class="modal-body">
											...
											<table class="table-striped ">
												<tr>
													<td>Name</td>
													<td>Md. Imadul Haque </td>
												</tr>
												<tr>
													<td>Email</td>
													<td>emdadulhq@gmail.com </td>
												</tr>
												<tr>
													<td>Cell</td>
													<td>01922581040 </td>
							...
							<div id="edit" class="modal fade">
								<div class="modal-dialog modal-dialog-centered">
									<div class="modal-content">
										<div class="modal-header">
											<h2 style="text-align: center;"> Edit User Permission </h2> <button
											...
											<div class="modal-body">
												...
												<table class="table-striped ">
													...
													<tr>
														...
														<td class="">
															<label for="quiz"> Quiz
																<input name="quiz" id="quiz" class="form-group"  value="Quiz,
															Mail, Course" type="checkbox" >
															</label>
															<label for="mail"> Mail
															<input name="mail" id="mail" class="form-group"
																   value="Mail,
															Mail, Course" type="checkbox" >
															</label>
															<label for="event"> Event
															<input name="event" id="event" class="form-group"
																   value="Event,
															Mail, Course" type="checkbox" >
															</label>
															<label for="course">Course
															<input name="course" id="course" class="form-group"
																   value="Course,
															Mail, Course" type="checkbox" >
															</label>
														</td>
