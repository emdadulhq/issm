...
<!-- Mirrored from 3i Scholling.themetrades.com/demo/admin/courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 13:10:19 GMT -->
<head>
						...
						<div class="widget-inner">
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="{{ URL::to('assets/images/courses/pic1.jpg') }}" alt=""/>
								</div>
										...
										<ul class="card-courses-view">
											<li class="card-courses-user">
												<div class="card-courses-user-pic">
													<img src="{{ URL::to('assets/images/testimonials/pic3.jpg') }}"
														 alt=""/>
												</div>
							...
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="{{URL::to('assets/images/courses/pic2.jpg')}}" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4>Become a PHP Master and Make Money</h4>
									...
									<div class="card-courses-list-bx">
										<ul class="card-courses-view">
											<li class="card-courses-user">
												<div class="card-courses-user-pic">
													<img src="{{URL::to('assets/images/courses/pic3.jpg')}} "alt="/>
												</div>
												<div class="card-courses-user-info">
													<h5>Teacher</h5>
													<h4>Keny White</h4>
							...
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="{{URL::to('assets/images/courses/pic4.jpg')}}" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4>Become a PHP Master and Make Money</h4>
...
<!-- Mirrored from 3i Scholling.themetrades.com/demo/admin/courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 13:11:35 GMT -->
</html>