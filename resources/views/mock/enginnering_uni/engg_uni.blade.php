...
<head>
  ...
  <title>Engineering_Universities</title>
...
<div class="navbar"><div class="navbar">
  ...
  <section id="skills">
    <h2>Engineering_Universities</h2>
    <div class="row">
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt=" image">
          <div class="card-body">
           <h5 class="card-title"><a href="{{url('mock/enggunite/buet')}}">BUET</a></h5>
	   ...
	   <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
                    <h5 class="card-title"><a href="{{url('mock/enggunite/ruet')}}">RUET</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
          <h5 class="card-title"><a href="{{url('mock/enggunite/kuet')}}">KUET</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
                    <h5 class="card-title"><a href="{{url('mock/enggunite/sust')}}">SUST</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
