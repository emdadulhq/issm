    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          ...
          <div class="card-body">
			<h5 class="card-title"><a href="{{url('mock/med/phy')}}">Physics</a></h5>
	   ...
	   <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('mock/med/math')}}">Maths</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
           <h5 class="card-title"><a href="{{url('mock/med/chem')}}">Chemistry</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
           <h5 class="card-title"><a href="{{url('mock/med/bio')}}">Biology</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
