...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="{{asset('assets/css/ssc.css')}}">
  <!-- JavaScript -->
  <script src="https://cdn.jsdelivr.net/npm/jquery@3.2.1/dist/jquery.min.js"></script>
  <script src="{{ asset('assets/Javascript/script.js') }}"></script>
  <title>Mock_SSC</title>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('mock/ssc/phy')}}">Physics</a></h5>
	   ...
	   <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('mock/ssc/math')}}">Maths</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('mock/ssc/chem')}}">Chemistry</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('mock/ssc/bio')}}">Biology</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
