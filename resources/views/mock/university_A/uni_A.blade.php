...
<div class="navbar">
  ...
  <section id="skills">
    <h2>University_A Unit</h2>
    <div class="row">
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt=" image">
          <div class="card-body">
           <h5 class="card-title"><a href="{{url('mock/unite/phy')}}">Physics</a></h5>
	   ...
	   <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('mock/unite/math')}}">Maths</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('mock/unite/chem')}}">Chemistry</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="" alt="image">
          <div class="card-body">
          <h5 class="card-title"><a href="{{url('mock/unite/bio')}}">Biology</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
