...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="{{asset('assets/css/sci.css')}}">
  <!-- JavaScript -->
  ...
  <section id="skills">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="{{asset('assets/images/ielts.gif')}}" alt=" image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('sci/ict')}}">ICT</a></h5>
      ...
      <div class="col-lg-3 col-md-6 mb-5">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('sci/kids_coding')}}">Kids Coding</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 mb-5">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('sci/mobile_lab')}}">Practical</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 mb-5">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('sci/practical')}}"> Mobile Lab</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
