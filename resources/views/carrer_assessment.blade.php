...
<head>
  ...
  <!-- CSS -->
    <link rel="stylesheet" href="{{asset('assets/css/career_assessment.css')}}">
  <!-- JavaScript -->
  ...
  <section id="skills">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="images/ielts.gif" alt=" image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('Career_Assessment/ielts')}}">IELTS</a></h5>
      ...
      <div class="col-lg-3 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="images/69QH.gif" alt="image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('Career_Assessment/gre')}}">GRE</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="images/Dmye.gif" alt="image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('Career_Assessment/aptitude')}}">Aptitude</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 mb-5">
        <div class="card">
          <img class="card-img-top" src="images/vcs.gif" alt="image">
          <div class="card-body">
            <h5 class="card-title"><a href="{{url('Career_Assessment/support')}}"> Support</a></h5>
            <p class="card-text text-muted">Short Description</p>
          </div>
        </div>
      </div>
