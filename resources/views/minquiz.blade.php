			...
			<div class="ttr-logo-box">
				<div>
					<a href="index.html" class="ttr-logo">
						...
						<img class="ttr-logo-desktop" alt="" src="assets/images/logo-white.png" width="100" height="17">
					</a>
				</div>
			</div>
			<!--logo end -->
	...
	<div class="ttr-sidebar">
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<div class="ttr-sidebar-logo">
				<a href="#"><img alt="" src="assets/images/logo.png" width="82" height="27"></a>
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					...
					<li>
						<a href="60minquiz.html" class="ttr-material-button">
							 ...
							 <div class="modal-dialog modal-dialog-centered">
								 <div class="modal-content">
									 <div class="modal-header">
										<h2 style="text-align: center;"> What does HTML stand for? </h2><button class="close" data-dismiss="modal">&times;</button>
									 </div>
